...
public class Theme {
    ...
    public static Color navColorSelect = new Color(0,109,103);
    ...
    private static Color dangerRedDefault = new Color(204,51, 51);
    private static Color dangerRedHOver = new Color(180,28,28);
    ...
    final public static int TABLE_COLOMN_WIDTH_SM = 8;
    final public static int TABLE_COLOMN_WIDTH_LG = 150;
    final public static int TABLE_COLOMN_WIDTH_ELG = 250;
