 ...
 * @author HASANKA
 */
public class Invoices extends PanelFrame {
    ...
    public Invoices() {
        initComponents();
        tb.update_table("SELECT invoice_id, customer_id, date, total, first_name, last_name as address FROM invoice inner join customer on customer.id = invoice.customer_id where date between '"+sdf.format(dateChooserCombo1.getSelectedDate().getTime())+"' and '"+sdf.format(dateChooserCombo1.getSelectedDate().getTime())+"' order by id desc", jTable1);
    }
    ...
    private void dateChooserCombo2OnSelectionChange(datechooser.events.SelectionChangedEvent evt) {//GEN-FIRST:event_dateChooserCombo2OnSelectionChange
        tb.update_table("SELECT invoice_id, barcode, customer_id, date, total, first_name, last_name as address FROM invoice inner join customer on customer.id = invoice.customer_id where date between '"+sdf.format(dateChooserCombo1.getSelectedDate().getTime())+"' and '"+sdf.format(dateChooserCombo1.getSelectedDate().getTime())+"' order by id desc", jTable1);

    }//GEN-LAST:event_dateChooserCombo2OnSelectionChange

    private void dateChooserCombo1OnSelectionChange(datechooser.events.SelectionChangedEvent evt) {//GEN-FIRST:event_dateChooserCombo1OnSelectionChange
                tb.update_table("SELECT distinct invoice_id, customer_id, date, total, first_name, last_name as address FROM invoice inner join customer on customer.id = invoice.customer_id inner join invoice_details on invoice.invoice_id=invoice_invoice_id where invoice.invoice_id like '%"+jTextField1.getText()+"%' or invoice_details.barcode like '%"+jTextField1.getText()+"%'", jTable1);
