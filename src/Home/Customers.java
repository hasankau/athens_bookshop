...
public class Customers extends PopupFrame {
     ...
     * @param cashier
     */
    public Customers(Home home, CashieStand cashier) {
        this();
        this.home = home;
        this.cashier = cashier;
        tb.update_table("select * from customer where first_name != 'New'", jTable1);
    ...
    public Customers(Home home, RepairJobs cashier) {
        this();
        this.home = home;
        this.rep = cashier;
        tb.update_table("select * from customer where first_name != 'New'", jTable1);
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        tb.update_table("select * from customer where first_name != 'New' and (first_name like "+key+" or last_name like "+key+" or tel like "+key+")", jTable1);
