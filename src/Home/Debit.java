 ...
 * @author HASANKA
 */
public class Debit extends PopupFrame {
    Home home = null;
    Stock stock = null;
    String table;
    static int cust; 
     ...
     * @param table
     */
    public Debit(Home home, String cus) {
        this();
        this.home = home;
        this.stock = stock;
        this.table = table;
        cust = Integer.parseInt(cus);
        tb.update_table("select @rank:=@rank+1 as Credit_ID, id, DATE, BILLNO as GRN_NO, sum(AMOUNT) as AMOUNT, STATE, REF_NO, DATE_PAID from supp_debit, (SELECT @rank := 0) r where sup_id = "+cust+" group by GRN_NO", jTable1);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        String bill = jTable1.getValueAt(jTable1.getSelectedRow(), 3).toString();
        String am = jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        a.setCustomer_id(cust+"");
        a.setId(jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString());
        a.setDATE(sdf.format(dateChooserCombo1.getSelectedDate().getTime()));
        a.setAMOUNT(jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString());
        a.setBILLNO(bn.getText());
        
        a.setAMOUNT(amount.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        int is[] = jTable1.getSelectedRows();
