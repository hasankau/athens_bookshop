...
public class DB_query {
    ...
    public String getItno(){
        String sql = "SELECT max(id)+1+1001 from item";
    ...
    public Vector loadItem(String barc){
        String sql = "SELECT barcode, name, item.description, manufacturer, threshold_value, qty, purchase_price, selling_price from item where barcode = '"+barc+"'";
        Vector v = new Vector();
        try {
    ...
    public boolean itemExistsIInvoices(String barcode){
        String sql = "SELECT * from invoice_details where Item_id =(select id from item where barcode = '"+barcode+"')";
    ...
    public boolean insertIntoItem(String barcode, String name, String desc, String manufacturer, String pprice, String sprice, String thresh, String qty, String type, String sno) {
        String sql = "insert into item(barcode, name, description, manufacturer, purchase_price, selling_price, threshold_value, qty, type, serial_no) values('" + barcode + "', '" + name + "', '" + desc + "', '" + manufacturer + "', '" + pprice + "', '"+sprice+"', '"+thresh+"', '"+qty+"', '"+type+"', '"+sno+"')";
        try {
    ...
    public boolean UpdateItem(String barcode, String name, String desc, String manufacturer, String pprice, String sprice, String thresh, String qty, String type, String sno) {
        String sql = "update item set name = '" + name + "', description = '" + desc + "', manufacturer = '" + manufacturer + "', threshold_value = '" + thresh + "', purchase_price='"+pprice
                +"', selling_price='"+sprice+"', threshold_value = '"+thresh+"', qty = '"+qty+"', type = '"+type+"', serial_no = '"+sno+"' where barcode='"+barcode+"'";
        try {
            pst = conn.prepareStatement(sql);
            pst.execute();
