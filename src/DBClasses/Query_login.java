...
public class Query_login {
        ...
        if (!userName.equals("")) {
            if (!password.equals("")) {
                String sql = "";
                    ...
                    sql = "select id,password, status from user where user=?";
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        if (PasswordHash.validatePassword(password, HashPwd)) {
                            ...
                            JOptionPane.showMessageDialog(null, "User account deactivated", "Invallid login", JOptionPane.ERROR_MESSAGE);
                        }
    ...
    public boolean saveLogout(int id, String time) {
        String sql = "insert into login (date, out_time, user_id) value('" + time + "', '" + id + "') where id = max(id)";
        try {
