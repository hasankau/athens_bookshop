...
public class DB_query_users {
    ...
    public boolean updateUser(String uname, String status) {
        
        String sql = "update user set status =  '" + status + "' WHERE user='" + uname +"'";
        System.out.println(sql);
        try {
    ...
    public String searchSuperSetPrices() {
       
        String sql = "SELECT STAFF_ITEM_PRICE FROM super_settings WHERE id = '1'";
        try {
    ...
    public String searchSuperSetRepair() {
       
        String sql = "SELECT REP FROM super_settings WHERE id = '1'";
        try {
    ...
    public boolean updateSuperSettings(String type, String status) {
        
        String sql = "update super_settings set "+type+" = '" + status + "'";
        System.out.println(sql);
        try {
    ...
    public Vector searchAll() {
       Vector v = new Vector();
        ...
        try {
            ...
            ResultSet rs2 = pst.executeQuery();
            if (rs2.first()) {
                v.add(rs2.getString(2)+"-"+rs2.getString(1));
            }
