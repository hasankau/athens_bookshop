...
public class DB_query_supplier {
    ...
    public boolean saveSupplier(String fname, String lname,String tel, String ad, String d, String em, String it) {
        String sql = "insert into supplier ( first_name, last_name, tel, address, registered_date, email, product_definition) value('" + fname + "', '" + lname + "', '" + tel + "', '" + ad + "', '" + d + "', '" + em + "', '" + it + "')";
        try {
    ...
    public boolean updateSupplier(String id, String fname, String lname, String tel, String ad, String d, String em, String it) {
        String sql = "update supplier set first_name='" + fname + "', last_name='" + lname + "', tel = '" + tel + "', address = '" + ad + "', registered_date = '" + d + "', email = '" + em + "', product_definition = '" + it + "' where supplier_id = '" + id + "'";
        try {
